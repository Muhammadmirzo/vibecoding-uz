...
INSERT INTO "portfolios" ("slug", "title", "url", "domain", "category", "description", "image_url", "badge_text", "is_featured", "sort_order", "live_url") VALUES ('clash-nexus', 'Clash Nexus', 'https://clash-nexus.vercel.app/', 'clash-nexus.vercel.app', 'Startup MVP', 'Clash of Clans muxlislari uchun klan qidiruv, reyting va o''zbek tilidagi jamoa vositalari.', '', 'Tekshirilgan jonli loyiha', true, 0, 'https://clash-nexus.vercel.app/') ON CONFLICT ("slug") DO NOTHING;--> statement-breakpoint
