...
const routes = [
  ...
  { path: "/shahodatnoma/DEMO2026", name: "shahodatnoma" },
  { path: "/kabinet", name: "kabinet" },
  { path: "/kabinet/baholar", name: "kabinet-baholar" },
  { path: "/kabinet/to-lovlar", name: "kabinet-tolovlar" },
  { path: "/kabinet/referral", name: "kabinet-referral" },
  { path: "/kabinet/sozlamalar", name: "kabinet-sozlamalar" },
  { path: "/kabinet/sertifikat", name: "kabinet-sertifikat" },
