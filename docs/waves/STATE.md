...
| W8B World-class MCP (remote HTTP + OAuth + visual charts) | space-bunny-free | 🏃 dispatched 2026-09-24 (W8A + W7 merged) | wave/w8b-mcp | reports/W8B-MCP.md | prompt prompts/w8b-mcp.md; port 3307 |
