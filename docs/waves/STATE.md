...
| :--- | :--- | :--- | :--- | :--- | :--- |
| W6A Design + motion: HOME | space-bunny-free | 🏃 round 2 (review fixes) — log .orchestra/logs/w6a-design-home-r2.log | wave/w6a-design-home (ee40309 + main merged e8503f7) | reports/W6A-DESIGN-HOME.md | round 1 rejected: story stage mostly empty + half-cut terminal + inactive step labels; ScrollFillText doubled/offset; bento typing cuts letters. Hero approved. Prompt: prompts/w6a-design-home-r2.md. Re-dispatch: `PROMPT=w6a-design-home-r2 scripts/waves/dispatch.sh w6a-design-home space-bunny-free` |
...
| W10 Cuts + fixes (close /ish, /testimoniyalar, SpinWheel, unbuilt features; PG rate limit; error leak; secrets audit) | muse-spark-1.3-contributor-free | 🏃 dispatched 2026-09-24 | wave/w10-cuts-fixes | reports/W10-CUTS-FIXES.md | prompt prompts/w10-cuts-fixes.md; port 3303; new migration (rate_limit_buckets) |
...
| W7 Chat centre (visitor ↔ admin ↔ AI agent, Telegram bridge) | space-bunny / muse | ⏳ QUEUED (owner approved 2026-09-24) — next free slot | wave/w7-chat | reports/W7-CHAT.md | prompt prompts/w7-chat.md; port 3305; AI = Anthropic provider, off without ANTHROPIC_API_KEY |
| W8A First-party analytics (tracking + services + admin dashboard) | space-bunny-free | 🏃 dispatched 2026-09-24 | wave/w8a-analytics | reports/W8A-ANALYTICS.md | prompt prompts/w8a-analytics.md; port 3304; new migration |
...
| W9 Mobile-ready API (/api/v1, bearer tokens, OpenAPI, deep links) | — | ⏳ QUEUED (owner approved) | wave/w9-mobile-api | reports/W9-MOBILE-API.md | prompt prompts/w9-mobile-api.md; port 3308; touches require-auth gate |
