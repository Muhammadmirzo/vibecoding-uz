...
- Name: responsive.spec.ts >> blog-first-post >> 1440px light
- Location: e2e/responsive.spec.ts:99:13

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3100/blog/vibe-coding-nima-va-u-qanday-ishlaydi
Call log:
  - navigating to "http://localhost:3100/blog/vibe-coding-nima-va-u-qanday-ishlaydi", waiting until "networkidle"
