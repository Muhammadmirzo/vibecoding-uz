...
- Name: responsive.spec.ts >> testimoniyalar >> 1440px light
- Location: e2e/responsive.spec.ts:99:13

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3100/testimoniyalar
Call log:
  - navigating to "http://localhost:3100/testimoniyalar", waiting until "networkidle"
