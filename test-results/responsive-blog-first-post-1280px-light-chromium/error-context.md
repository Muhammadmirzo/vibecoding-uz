...
- Name: responsive.spec.ts >> blog-first-post >> 1280px light
- Location: e2e/responsive.spec.ts:99:13

# Error details

```
Error: page.goto: net::ERR_EMPTY_RESPONSE at http://localhost:3100/blog/vibe-coding-nima-va-u-qanday-ishlaydi
Call log:
