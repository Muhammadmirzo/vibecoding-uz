...
function ToolList({ duplicate = false }: { duplicate?: boolean }) {
  return (
    <div className="flex w-max shrink-0 items-center gap-8 sm:gap-10" aria-hidden={duplicate || undefined}>
      {tools.map((tool) => (
  ...
  return (
    <section aria-label="Ishlatiladigan texnologiyalar" className="border-y border-border bg-bg-sunken">
      <Container className="py-4 sm:py-5">
        ...
        <div className="-mx-5 overflow-x-auto px-5 motion-safe:overflow-hidden lg:hidden">
