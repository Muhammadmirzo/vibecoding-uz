...
export function PortfolioCard({ item }: { item: PortfolioItem }) {
  ...
  return <a href={item.url} target="_blank" rel="noreferrer" className="group w6c-cover flex flex-col overflow-hidden rounded-xl border border-border bg-bg-elevated shadow-sm transition hover:-translate-y-1 hover:border-brand hover:shadow-md" style={{ "--w6c-vt": `cover-${item.id}` } as React.CSSProperties}>
