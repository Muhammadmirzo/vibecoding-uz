...
export function PortfolioManager() {
  ...
  return (
    <div className="space-y-6">
      ...
      <PortfolioTable items={filters.filteredItems} isLoading={portfolio.isLoading} onEdit={portfolio.openEdit} onDelete={portfolio.remove} onToggleFeatured={portfolio.toggleFeatured} onMove={portfolio.move} onQuickField={portfolio.setQuickField} />
