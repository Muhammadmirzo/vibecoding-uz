      ...
      {true && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-ink/60 backdrop-blur-sm animate-in fade-in">
          <div className="bg-bg-sunken border border-border rounded-2xl max-w-md w-full p-6 space-y-5 shadow-xl">
            ...
            {error && (
              <div className="p-3 rounded-lg bg-danger-soft border border-danger/20 text-danger text-xs font-medium">
                {error}
              </div>
            )}
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 text-sm bg-bg-elevated border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 text-sm bg-bg-elevated border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent font-mono"
                />
              </div>
