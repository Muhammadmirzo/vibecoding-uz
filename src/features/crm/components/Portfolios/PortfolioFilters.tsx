...
export function PortfolioFilters({ itemsCount, searchQuery, selectedCategory, onSearch, onCategory }: Props) {
  return (
      <>
      <div className="flex flex-col sm:flex-row items-center gap-4 bg-bg-elevated border border-border p-4 rounded-xl">
        <div className="relative flex-1 w-full">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 text-sm bg-bg-sunken border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent"
          />
        </div>
