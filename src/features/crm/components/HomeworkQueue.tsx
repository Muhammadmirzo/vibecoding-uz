      ...
      {selectedSubmission && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-ink/50 backdrop-blur-sm animate-in fade-in">
          <div className="bg-cream border border-border rounded-xl shadow-lg max-w-2xl w-full max-h-[90vh] flex flex-col overflow-hidden">
            ...
            <div className="px-6 py-4 border-t border-border bg-cream-warm flex items-center justify-between">
              <button
                type="button"
                onClick={() => setSelectedSubmission(null)}
              ...
              <div className="flex items-center space-x-3">
                ...
                >
                  ...
                  Qayta topshirish talab qilish
                </button>
                <button
                  type="button"
                  onClick={() => handleGradeSubmission("approved")}
                  className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-sm font-medium transition-colors flex items-center space-x-1"
                  disabled={submitting}
                >
