...
export function ActivityFilters({ search, setSearch, statusFilter, setStatusFilter }: Props) { return (<>
      {/* Filter Toolbar */}
      <div className="p-4 rounded-xl bg-bg-sunken border border-border flex flex-col sm:flex-row items-center gap-3">
        {/* Search Input */}
        <div className="relative flex-1 w-full">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 rounded-lg bg-bg-elevated border border-border text-xs text-ink placeholder:text-ink-subtle focus:outline-none focus:ring-2 focus:ring-accent"
          />
        </div>
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          ...
          <select
            ...
            className="w-full sm:w-44 px-3 py-2 rounded-lg bg-bg-elevated border border-border text-xs text-ink focus:outline-none focus:ring-2 focus:ring-accent"
          >
