    ...
    >
      ...
      <div className="flex items-center justify-between text-white text-xs font-mono">
        <div className="flex items-center space-x-3">
          <button onClick={controller.togglePlay} className="p-1.5 rounded-md hover:bg-cream/20 transition-colors" title={controller.isPlaying ? "Pauza" : "Ijro etish"}>
          ...
          <div className="flex items-center space-x-1.5 group/vol">
            <button onClick={controller.toggleMute} className="p-1.5 rounded-md hover:bg-cream/20 transition-colors" title={controller.isMuted ? "Ovozsiz rejimdan chiqarish" : "Ovozsiz rejim"}>
        ...
        <div className="flex items-center space-x-2 relative">
          <div className="relative">
            <button onClick={() => setShowSpeedMenu(!controller.showSpeedMenu)} className="px-2.5 py-1 rounded-md bg-cream/15 hover:bg-cream/25 text-[11px] font-semibold flex items-center gap-1 transition-colors">
          ...
          <button onClick={controller.toggleFullscreen} className="p-1.5 rounded-md hover:bg-cream/20 transition-colors" title={controller.isFullscreen ? "Kichik ekranga o'tish" : "To'liq ekran"}>
