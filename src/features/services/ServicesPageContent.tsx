...
export function ServicesPageContent() {
  ...
  return <div className="bg-bg text-ink">
    <Section eyebrow="Agentlik xizmatlari" title="G'oyangizni ishlaydigan mahsulotga aylantiramiz." subtitle={page.promise}>
      <Button href="#taklif" size="lg">Taklif olish <ArrowUpRight className="size-4" aria-hidden="true" /></Button>
    </Section>
