      ...
      <div className="mx-auto w-full max-w-[1360px] space-y-12 px-5 md:px-8 lg:px-10">
        <header className="mx-auto max-w-[760px] space-y-4 text-center">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight text-ink md:text-5xl">
            Mirzo Academy jamoasiga <span className="accent-serif">qo'shiling</span>
          </h1>
        ...
        <section className="flex flex-col items-center justify-between gap-6 rounded-2xl border border-accent-line bg-cream-warm p-8 shadow-sm md:flex-row md:p-10">
