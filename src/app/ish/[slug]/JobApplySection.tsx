    ...
    <div className="lg:col-span-5 lg:sticky lg:top-24">
      <div className="bg-bg-elevated border-2 border-border rounded-2xl p-6 md:p-8 shadow-lg space-y-6">
        <div className="space-y-1">
          ...
          <p className="text-xs text-ink-muted">Telefon raqamingiz va rezyumeingizni qoldiring. Ariza qabul qilingandan so&apos;ng aloqa jarayoni alohida boshqariladi.</p>
        </div>
        {form.success ? (
          <div className="py-8 text-center space-y-4">
            ...
            <p className="text-xs text-ink-muted leading-relaxed">
              Hurmatli <strong className="text-ink">{form.fullName}</strong>, arizangiz saqlandi. HR jamoasi bilan aloqa jarayoni alohida boshqariladi.
            </p>
